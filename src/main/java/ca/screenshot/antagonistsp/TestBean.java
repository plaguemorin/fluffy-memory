...
public class TestBean {
    ...
    public void execute() {
        ...
        Category categoryHandiness = categoriesRepository.save(new Category(topCategoryQuirks, "Handiness"));
        Category categoryQuirksPhysical = categoriesRepository.save(new Category(topCategoryQuirks, "Physical"));
        Category categoryQuirksMental = categoriesRepository.save(new Category(topCategoryQuirks, "Mental"));
        Category categoryQuirksSocial = categoriesRepository.save(new Category(topCategoryQuirks, "Social"));
        Category categoryQuirksPlot = categoriesRepository.save(new Category(topCategoryQuirks, "Plot"));
        Category categoryQuirksSupernatural = categoriesRepository.save(new Category(topCategoryQuirks, "Supernatural"));
        ...
        descriptorsRepository.saveAll(Stream.of(
                new Descriptor(categoryHandiness, "Left Handed", 0),
                new Descriptor(categoryHandiness, "Right Handed", 0),
                new Descriptor(categoryHandiness, "Ambidexterity", 1),
                ...
                new Descriptor(categoryQuirksPhysical, "Accustomed to the Dark", 1),
                new Descriptor(categoryQuirksPhysical, "Alcohol Tolerance", 1),
                new Descriptor(categoryQuirksPhysical, "Arm Wrestler", 1),
                new Descriptor(categoryQuirksPhysical, "Breath Holding", 1),
                new Descriptor(categoryQuirksPhysical, "Distance Runner", 1),
                new Descriptor(categoryQuirksPhysical, "Good Swimmer", 1),
                new Descriptor(categoryQuirksPhysical, "Heavy Lifter", 1),
                new Descriptor(categoryQuirksPhysical, "High Pain Threshold", 1),
                new Descriptor(categoryQuirksPhysical, "Light Sleeper", 1),
                new Descriptor(categoryQuirksPhysical, "Longevity", 1),
                new Descriptor(categoryQuirksPhysical, "Strong Digestion System", 1),
                new Descriptor(categoryQuirksPhysical, "Strong Immune System", 1),
                new Descriptor(categoryQuirksPhysical, "Very Flexible", 1),
                new Descriptor(categoryQuirksMental, "Absolute Direction", 1),
                new Descriptor(categoryQuirksMental, "Absolute Timing", 1),
                new Descriptor(categoryQuirksMental, "Analytical Mind", 1),
                new Descriptor(categoryQuirksMental, "Animal Empathy", 1),
                new Descriptor(categoryQuirksMental, "Appraiser", 1),
                new Descriptor(categoryQuirksMental, "Artistic Ability", 1),
                new Descriptor(categoryQuirksMental, "Ascetic", 1),
                new Descriptor(categoryQuirksMental, "Cartographer", 1),
                new Descriptor(categoryQuirksMental, "Cultured", 1),
                new Descriptor(categoryQuirksMental, "Focussed Concentration", 1),
                new Descriptor(categoryQuirksMental, "Good Cook", 1),
                new Descriptor(categoryQuirksMental, "Green Thumb", 1),
                new Descriptor(categoryQuirksMental, "Hypnotizer", 1),
                new Descriptor(categoryQuirksMental, "Insomniac", 1),
                new Descriptor(categoryQuirksMental, "Jury Rigger", 1),
                new Descriptor(categoryQuirksMental, "Know Animal Tracks", 1),
                new Descriptor(categoryQuirksMental, "Know Braille", 1),
                new Descriptor(categoryQuirksMental, "Know Morse Code", 1),
                new Descriptor(categoryQuirksMental, "Know Semaphore Flag Signalling", 1),
                new Descriptor(categoryQuirksMental, "Know Signs language", 1),
                new Descriptor(categoryQuirksMental, "Know Trail Signs", 1),
                new Descriptor(categoryQuirksMental, "Lightning Calculator", 1),
                new Descriptor(categoryQuirksMental, "Literacy", 1),
                new Descriptor(categoryQuirksMental, "Maritime Knowledge", 1),
                new Descriptor(categoryQuirksMental, "Mathematical Ability", 1),
                new Descriptor(categoryQuirksMental, "Musical Ability", 1),
                new Descriptor(categoryQuirksMental, "Obscure Knowledge", 1),
                new Descriptor(categoryQuirksMental, "Photographic Memory", 1),
                new Descriptor(categoryQuirksMental, "Polyglot", 1),
                new Descriptor(categoryQuirksMental, "Professional Gambler", 1),
                new Descriptor(categoryQuirksMental, "Read Lips", 1),
                new Descriptor(categoryQuirksMental, "Sea Legs", 1),
                new Descriptor(categoryQuirksMental, "Supernatural Knowledge", 1),
                new Descriptor(categoryQuirksMental, "Tireless Reader", 1),
                new Descriptor(categoryQuirksSocial, "Blandness*", 1),
                new Descriptor(categoryQuirksSocial, "Famous (why)", 1),
                new Descriptor(categoryQuirksSocial, "Feared Reputation", 1),
                new Descriptor(categoryQuirksSocial, "Fearlessness", 1),
                new Descriptor(categoryQuirksSocial, "Good First Impression", 1),
                new Descriptor(categoryQuirksSocial, "Good Reputation", 1),
                new Descriptor(categoryQuirksSocial, "Incorruptible", 1),
                new Descriptor(categoryQuirksSocial, "Influent Family*", 1),
                new Descriptor(categoryQuirksSocial, "Influential Position", 1),
                new Descriptor(categoryQuirksSocial, "More Contacts*", 1),
                new Descriptor(categoryQuirksSocial, "More Slugs*", 1),
                new Descriptor(categoryQuirksSocial, "Natural Leader", 1),
                new Descriptor(categoryQuirksSocial, "Nice Singing Voice or Booming Voice", 1),
                new Descriptor(categoryQuirksSocial, "True Love", 1),
                new Descriptor(categoryQuirksSocial, "Virtuoso", 1),
                new Descriptor(categoryQuirksPlot, "Black Market Knowledge", 1),
                new Descriptor(categoryQuirksPlot, "Blackmail Documents", 1),
                new Descriptor(categoryQuirksPlot, "Faction Identification Card or Tattoos*", 1),
                new Descriptor(categoryQuirksPlot, "Faction Knowledge", 1),
                new Descriptor(categoryQuirksPlot, "Hidden Stash", 1),
                new Descriptor(categoryQuirksPlot, "Know a Dark Secret", 1),
                new Descriptor(categoryQuirksPlot, "Know the Location of a Mysterious Place", 1),
                new Descriptor(categoryQuirksPlot, "Know the Secret of a Player’s Character*", 1),
                new Descriptor(categoryQuirksPlot, "Know the Secret of an Important Non-Player", 1),
                new Descriptor(categoryQuirksPlot, "Character", 1),
                new Descriptor(categoryQuirksPlot, "Member of a Secret Group*", 1),
                new Descriptor(categoryQuirksPlot, "Paid Job*", 1),
                new Descriptor(categoryQuirksPlot, "Rank in a group", 1),
                new Descriptor(categoryQuirksPlot, "Safe Location*", 1),
                new Descriptor(categoryQuirksPlot, "Saw Something Strang", 1),
                new Descriptor(categoryQuirksSupernatural, "Do not attract monsters in the Gloom", 1),
                new Descriptor(categoryQuirksSupernatural, "Stained Object", 1),
                new Descriptor(categoryQuirksSupernatural, "Subtile Powers", 1),
                new Descriptor(categoryQuirksSupernatural, "Tolerated Supernatural Reputation", 1),
                new Descriptor(categoryQuirksPhysical, "Albinism", -1),
                new Descriptor(categoryQuirksPhysical, "Alcohol Intolerance", -1),
                new Descriptor(categoryQuirksPhysical, "Allergy (substance)", -1),
                new Descriptor(categoryQuirksPhysical, "Anemic", -1),
                new Descriptor(categoryQuirksPhysical, "Aphonia, permanent", -1),
                new Descriptor(categoryQuirksPhysical, "Blind (Major)", -1),
                new Descriptor(categoryQuirksPhysical, "Color Blindness", -1),
                new Descriptor(categoryQuirksPhysical, "Deep Sleeper", -1),
                new Descriptor(categoryQuirksPhysical, "Distinctive Appearance", -1),
                new Descriptor(categoryQuirksPhysical, "Epilepsy (Major)", -1),
                new Descriptor(categoryQuirksPhysical, "Eunuch", -1),
                new Descriptor(categoryQuirksPhysical, "Gigantism", -1),
                new Descriptor(categoryQuirksPhysical, "Heavy Sleeper", -1),
                new Descriptor(categoryQuirksPhysical, "Short-Winded", -1),
                new Descriptor(categoryQuirksPhysical, "Hemophilic (Major)", -1),
                new Descriptor(categoryQuirksPhysical, "Intolerance (substance)", -1),
                new Descriptor(categoryQuirksPhysical, "Limper", -1),
                new Descriptor(categoryQuirksPhysical, "Mute (Major)", -1),
                new Descriptor(categoryQuirksPhysical, "No Sense of Small/Taste", -1),
                new Descriptor(categoryQuirksPhysical, "One-Armed (Major)", -1),
                new Descriptor(categoryQuirksPhysical, "One-Legged (Major)", -1),
                new Descriptor(categoryQuirksPhysical, "Unmistakable Feature", -1),
                new Descriptor(categoryQuirksPhysical, "Weak Stomach", -1),
                new Descriptor(categoryQuirksMental, "Absent-Mindedness", -1),
                new Descriptor(categoryQuirksMental, "Addiction (substance)", -1),
                new Descriptor(categoryQuirksMental, "Agoraphobic", -1),
                new Descriptor(categoryQuirksMental, "Anxiety", -1),
                new Descriptor(categoryQuirksMental, "Apostate", -1),
                new Descriptor(categoryQuirksMental, "Apprehensive", -1),
                new Descriptor(categoryQuirksMental, "Aquaphobia", -1),
                new Descriptor(categoryQuirksMental, "Archaic", -1),
                new Descriptor(categoryQuirksMental, "Bad Habits (what)", -1),
                new Descriptor(categoryQuirksMental, "Bigotry", -1),
                new Descriptor(categoryQuirksMental, "Broken", -1),
                new Descriptor(categoryQuirksMental, "Claustrophobic", -1),
                new Descriptor(categoryQuirksMental, "Conspirationist", -1),
                new Descriptor(categoryQuirksMental, "Delusions", -1),
                new Descriptor(categoryQuirksMental, "Depressive", -1),
                new Descriptor(categoryQuirksMental, "Dyslexic", -1),
                new Descriptor(categoryQuirksMental, "Easily Surprised", -1),
                new Descriptor(categoryQuirksMental, "Fanatic (what)", -1),
                new Descriptor(categoryQuirksMental, "Fear of the Dark", -1),
                new Descriptor(categoryQuirksMental, "Flash-Back (why)", -1),
                new Descriptor(categoryQuirksMental, "Forgetfull", -1),
                new Descriptor(categoryQuirksMental, "Formalist", -1),
                new Descriptor(categoryQuirksMental, "Fragile", -1),
                new Descriptor(categoryQuirksMental, "Gambling Addiction", -1),
                new Descriptor(categoryQuirksMental, "Glory Seeker", -1),
                new Descriptor(categoryQuirksMental, "Gluttony", -1),
                new Descriptor(categoryQuirksMental, "Hoarder", -1),
                new Descriptor(categoryQuirksMental, "Illiteracy", -1),
                new Descriptor(categoryQuirksMental, "Impulsiveness", -1),
                new Descriptor(categoryQuirksMental, "Insane", -1),
                new Descriptor(categoryQuirksMental, "Insatiable Curiosity", -1),
                new Descriptor(categoryQuirksMental, "Kamikaze", -1),
                new Descriptor(categoryQuirksMental, "Kleptomania", -1),
                new Descriptor(categoryQuirksMental, "Know-it-All", -1),
                new Descriptor(categoryQuirksMental, "Lame", -1),
                new Descriptor(categoryQuirksMental, "Laziness", -1),
                new Descriptor(categoryQuirksMental, "Loss of Confidence", -1),
                new Descriptor(categoryQuirksMental, "Low Pain Tolerance", -1),
                new Descriptor(categoryQuirksMental, "Megalomania", -1),
                new Descriptor(categoryQuirksMental, "Mental Illness", -1),
                new Descriptor(categoryQuirksMental, "Miserliness", -1),
                new Descriptor(categoryQuirksMental, "Moral Qualms", -1),
                new Descriptor(categoryQuirksMental, "Multiple Personalities", -1),
                new Descriptor(categoryQuirksMental, "Naive", -1),
                new Descriptor(categoryQuirksMental, "Nightmare", -1),
                new Descriptor(categoryQuirksMental, "No Sense of Direction", -1),
                new Descriptor(categoryQuirksMental, "Oathsworn", -1),
                new Descriptor(categoryQuirksMental, "Obsessive", -1),
                new Descriptor(categoryQuirksMental, "Opportunist", -1),
                new Descriptor(categoryQuirksMental, "Overconfidence", -1),
                new Descriptor(categoryQuirksMental, "Overly Ambitious", -1),
                new Descriptor(categoryQuirksMental, "Pacifist", -1),
                new Descriptor(categoryQuirksMental, "Paranoia", -1),
                new Descriptor(categoryQuirksMental, "Perpetual Victim", -1),
                new Descriptor(categoryQuirksMental, "Phobia (which)", -1),
                new Descriptor(categoryQuirksMental, "Post-Traumatic Stress Disorder (PTSD)", -1),
                new Descriptor(categoryQuirksMental, "Primitive", -1),
                new Descriptor(categoryQuirksMental, "Prone to Distraction", -1),
                new Descriptor(categoryQuirksMental, "Pyromania", -1),
                new Descriptor(categoryQuirksMental, "Repressed Memories", -1),
                new Descriptor(categoryQuirksMental, "Ruthless", -1),
                new Descriptor(categoryQuirksMental, "Sadistic", -1),
                new Descriptor(categoryQuirksMental, "Schizophrenia", -1),
                new Descriptor(categoryQuirksMental, "Scorched", -1),
                new Descriptor(categoryQuirksMental, "Sens of Duty", -1),
                new Descriptor(categoryQuirksMental, "Short-Winded", -1),
                new Descriptor(categoryQuirksMental, "Somnambule", -1),
                new Descriptor(categoryQuirksMental, "Spendthrift", -1),
                new Descriptor(categoryQuirksMental, "Split Personality", -1),
                new Descriptor(categoryQuirksMental, "Tourette Syndrome", -1),
                new Descriptor(categoryQuirksMental, "Trill Seeker", -1),
                new Descriptor(categoryQuirksMental, "Truthfulness", -1),
                new Descriptor(categoryQuirksMental, "Uneducated", -1),
                new Descriptor(categoryQuirksMental, "Vertigo", -1),
                new Descriptor(categoryQuirksMental, "Weak Will", -1),
                new Descriptor(categoryQuirksMental, "Workaholic", -1),
                new Descriptor(categoryQuirksSocial, "Abusive", -1),
                new Descriptor(categoryQuirksSocial, "Aggressive", -1),
                new Descriptor(categoryQuirksSocial, "Alcoholism", -1),
                new Descriptor(categoryQuirksSocial, "Aloof", -1),
                new Descriptor(categoryQuirksSocial, "Animals don’t like you", -1),
                new Descriptor(categoryQuirksSocial, "Anthropophobia", -1),
                new Descriptor(categoryQuirksSocial, "Antisocial", -1),
                new Descriptor(categoryQuirksSocial, "Arrogant", -1),
                new Descriptor(categoryQuirksSocial, "Authoritative", -1),
                new Descriptor(categoryQuirksSocial, "Avarice", -1),
                new Descriptor(categoryQuirksSocial, "Bad Reputation (why)", -1),
                new Descriptor(categoryQuirksSocial, "Bad Temper", -1),
                new Descriptor(categoryQuirksSocial, "Berserker", -1),
                new Descriptor(categoryQuirksSocial, "Blasphemer", -1),
                new Descriptor(categoryQuirksSocial, "Branded a Coward", -1),
                new Descriptor(categoryQuirksSocial, "Brash", -1),
                new Descriptor(categoryQuirksSocial, "Bully", -1),
                new Descriptor(categoryQuirksSocial, "By the Book", -1),
                new Descriptor(categoryQuirksSocial, "Childish", -1),
                new Descriptor(categoryQuirksSocial, "Competitive", -1),
                new Descriptor(categoryQuirksSocial, "Compulsive Behaviour", -1),
                new Descriptor(categoryQuirksSocial, "Compulsive Generosity", -1),
                new Descriptor(categoryQuirksSocial, "Compulsive Liar", -1),
                new Descriptor(categoryQuirksSocial, "Corruptible", -1),
                new Descriptor(categoryQuirksSocial, "Cowardice", -1),
                new Descriptor(categoryQuirksSocial, "Creepy", -1),
                new Descriptor(categoryQuirksSocial, "Daredevil", -1),
                new Descriptor(categoryQuirksSocial, "Debauched", -1),
                new Descriptor(categoryQuirksSocial, "Defiant", -1),
                new Descriptor(categoryQuirksSocial, "Denouncer", -1),
                new Descriptor(categoryQuirksSocial, "Despised (why)", -1),
                new Descriptor(categoryQuirksSocial, "Dipsomaniac", -1),
                new Descriptor(categoryQuirksSocial, "Disliked (why)", -1),
                new Descriptor(categoryQuirksSocial, "Distinctive Style (style)", -1),
                new Descriptor(categoryQuirksSocial, "Eccentric", -1),
                new Descriptor(categoryQuirksSocial, "Excessive Code of Honor", -1),
                new Descriptor(categoryQuirksSocial, "Excessive Honesty", -1),
                new Descriptor(categoryQuirksSocial, "Excessive Piety", -1),
                new Descriptor(categoryQuirksSocial, "Excessive Virtue", -1),
                new Descriptor(categoryQuirksSocial, "Fickle", -1),
                new Descriptor(categoryQuirksSocial, "Good Samaritan", -1),
                new Descriptor(categoryQuirksSocial, "Greed", -1),
                new Descriptor(categoryQuirksSocial, "Grudgekeeper", -1),
                new Descriptor(categoryQuirksSocial, "Gullibility", -1),
                new Descriptor(categoryQuirksSocial, "Homophobic", -1),
                new Descriptor(categoryQuirksSocial, "In a Minority Group (which)", -1),
                new Descriptor(categoryQuirksSocial, "Infamy", -1),
                new Descriptor(categoryQuirksSocial, "Insensitive", -1),
                new Descriptor(categoryQuirksSocial, "Jealousy", -1),
                new Descriptor(categoryQuirksSocial, "Laconic", -1),
                new Descriptor(categoryQuirksSocial, "Lecherous", -1),
                new Descriptor(categoryQuirksSocial, "Lechery", -1),
                new Descriptor(categoryQuirksSocial, "Literal-Minded", -1),
                new Descriptor(categoryQuirksSocial, "Loathsome", -1),
                new Descriptor(categoryQuirksSocial, "Loner", -1),
                new Descriptor(categoryQuirksSocial, "Loud Sleeper", -1),
                new Descriptor(categoryQuirksSocial, "Manipulative", -1),
                new Descriptor(categoryQuirksSocial, "Naive", -1),
                new Descriptor(categoryQuirksSocial, "No Contact", -1),
                new Descriptor(categoryQuirksSocial, "Odious Personal Habits", -1),
                new Descriptor(categoryQuirksSocial, "Overt", -1),
                new Descriptor(categoryQuirksSocial, "Pessimistic", -1),
                new Descriptor(categoryQuirksSocial, "Prone to Anger", -1),
                new Descriptor(categoryQuirksSocial, "Proud", -1),
                new Descriptor(categoryQuirksSocial, "Psychotic", -1),
                new Descriptor(categoryQuirksSocial, "Racist", -1),
                new Descriptor(categoryQuirksSocial, "Rebellious", -1),
                new Descriptor(categoryQuirksSocial, "Repulsive", -1),
                new Descriptor(categoryQuirksSocial, "Restrictive Diet", -1),
                new Descriptor(categoryQuirksSocial, "Secretive", -1),
                new Descriptor(categoryQuirksSocial, "Selfish", -1),
                new Descriptor(categoryQuirksSocial, "Sexist", -1),
                new Descriptor(categoryQuirksSocial, "Shy", -1),
                new Descriptor(categoryQuirksSocial, "Social Stigma (what)", -1),
                new Descriptor(categoryQuirksSocial, "Social Stress", -1),
                new Descriptor(categoryQuirksSocial, "Stubborn", -1),
                new Descriptor(categoryQuirksSocial, "Uncouth", -1),
                new Descriptor(categoryQuirksSocial, "Wretched", -1),
                new Descriptor(categoryQuirksSocial, "Zoophobia", -1),
                new Descriptor(categoryQuirksPlot, "Amnesia", -1),
                new Descriptor(categoryQuirksPlot, "Blackmailed (by who and why)", -1),
                new Descriptor(categoryQuirksPlot, "Crime Tattoos*", -1),
                new Descriptor(categoryQuirksPlot, "Cursed (by who)", -1),
                new Descriptor(categoryQuirksPlot, "Dark Fate (which fate)", -1),
                new Descriptor(categoryQuirksPlot, "Dark Secret (secret)*", -1),
                new Descriptor(categoryQuirksPlot, "Debts (to who)*", -1),
                new Descriptor(categoryQuirksPlot, "Done something terrible (what)", -1),
                new Descriptor(categoryQuirksPlot, "Enemy (who)", -1),
                new Descriptor(categoryQuirksPlot, "Exiled (from where)", -1),
                new Descriptor(categoryQuirksPlot, "Family betrayed and seeking revenge", -1),
                new Descriptor(categoryQuirksPlot, "Friend or Family Kidnapped", -1),
                new Descriptor(categoryQuirksPlot, "Fugitive", -1),
                new Descriptor(categoryQuirksPlot, "Harassed (by who)", -1),
                new Descriptor(categoryQuirksPlot, "Haunted (why)", -1),
                new Descriptor(categoryQuirksPlot, "Homeless*", -1),
                new Descriptor(categoryQuirksPlot, "Hunted (who)", -1),
                new Descriptor(categoryQuirksPlot, "Impostor", -1),
                new Descriptor(categoryQuirksPlot, "Known Criminal", -1),
                new Descriptor(categoryQuirksPlot, "Oath of Revenge", -1),
                new Descriptor(categoryQuirksPlot, "Obsessed by vengeance", -1),
                new Descriptor(categoryQuirksPlot, "Outcast", -1),
                new Descriptor(categoryQuirksPlot, "Owes Favor", -1),
                new Descriptor(categoryQuirksPlot, "Poverty", -1),
                new Descriptor(categoryQuirksPlot, "Prejudiced", -1),
                new Descriptor(categoryQuirksPlot, "Stalked (by who and why)", -1),
                new Descriptor(categoryQuirksPlot, "Vow (which)", -1),
                new Descriptor(categoryQuirksPlot, "You hunt someone (who)", -1),
                new Descriptor(categoryQuirksSupernatural, "Activation of powers on Anger", -1),
                new Descriptor(categoryQuirksSupernatural, "Blackmailed because of Powers", -1),
                new Descriptor(categoryQuirksSupernatural, "Known by some to have Powers", -1),
                new Descriptor(categoryQuirksSupernatural, "Physical effects when using Powers*", -1),
                new Descriptor(categoryQuirksSupernatural, "Attract More Monsters in the Gloom", -1),
                new Descriptor(categoryQuirksSupernatural, "Supernatural Appearance*", -1),
                new Descriptor(categoryQuirksSupernatural, "Refuse to use Stained Objects", -1)
        ).toList());
